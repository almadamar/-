...
async def auto_info(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if "tiktok.com" in text: await update.message.reply_text("🎬 تم التعرف على رابط تيك توك...")
    elif "instagram.com" in text: await update.message.reply_text("📸 تم التعرف على رابط إنستغرام...")
